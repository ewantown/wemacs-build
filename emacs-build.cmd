...
:default
emacs-build.cmd --clone --deps --build --with-w32-vt-color=256 --pack-emacs --aspell --pack-all
goto:eof

:nativecomp
emacs-build.cmd --nativecomp --clone --deps --build --with-w32-vt-color=256 --pack-emacs --aspell --pack-all
goto:eof
